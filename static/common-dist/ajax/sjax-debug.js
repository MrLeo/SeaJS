define("static/common-dist/ajax/sjax-debug", [], function(require, exports, module) {
    /**
    ...
    exports.Sjax = function(win) {
        var ie678 = !-[ 1 ], opera = win.opera, doc = win.document, head = doc.getElementsByTagName("head")[0], timeout = 3e3, done = false;
        ...
        function request(url, opt) {
            function fn() {}
            var opt = opt || {}, data = opt.data, success = opt.success || fn, failure = opt.failure || fn, scope = opt.scope || win, timestamp = opt.timestamp;
