define("static/common-dist/map/baidu-map-debug", [], function(require, exports, module) {
    /**
	 * 百度地图API功能
    ...
    exports.initMap = function(mapControl, myLng, myLat, zoom) {
        map = new BMap.Map(mapControl);
        //-- 创建Map实例
        var point = new BMap.Point(myLng, myLat);
        //-- 创建点坐标
        map.centerAndZoom(point, zoom || 15);
        //-- 初始化地图,设置"中心点坐标"和"地图缩放级别"。
    ...
    exports.addInfoWindow = function(marker, info, getGPS) {
        if (getGPS) info += '<a href="javascript:void(0);" id="goGPS">一键导航</a>';
        //-- 信息窗口的内容，添加一键导航
