define("static/common-dist/array/where-debug", [], function(require, exports, module) {
    /**
    ...
    Array.prototype.where = function(f) {
        ...
        if (typeof f == "string") // try to make it into a function
        if ((fn = lambda(fn)) == null) // if fail, throw exception
