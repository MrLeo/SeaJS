define("static/common-dist/qrcode/generate-qrcode-debug", [ "jquery-debug" ], function(require, exports, module) {
    var $ = require("static/libs/jquery/jquery-1.8.3.min-debug");
    require("./jquery.qrcode-debug");
    var qrcode = "<style>";
